...
export default {
  ...
  run: async (conn, m, args) => {
    ...
    if (command === 'orcado' || command === 'ahorcado') {
      ...
      const mensaje = `°      　𝜗ϱ　　　˚　　　🪢 AHORCADO ⁺

୨  🦭 ୧ 𝗝ᥙgᥲძ᥆r : ${jugador}

૮(ˊ ᵔ ˋ)ა ׅ  ׄ 🔘̼̼  ׅ   :: 𝗣alabra :
...
❌֧֪ꯪ⃪⃤͛    Incorrecto: ${letra}

> ${palabraOculta}

ׁ 🪢̶̫  𝅼 ㅤׁ  :: Intentos: ${ahorcadoStages.length - 1 - partida.errores}`
      }, { quoted: m })
    }
  }
}