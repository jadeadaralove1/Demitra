  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    try {
      ...
      if (participant?.admin)
        return client.sendMessage(m.chat, { text: `🐢▸ㅤㅤ⏌ㅤㅤ.  *@${who.split('@')[0]}* ya es administrador del grupo!`, mentions: [who] }, { quoted: m })
      await client.groupParticipantsUpdate(m.chat, [who], 'promote')
      await client.sendMessage(m.chat, { text: `ׄㅤֶָ֪ㅤಟㅤׄ    𝗦𝖾 𝖺 𝖽𝗮𝗱𝗼 *@${who.split('@')[0]}*  𝖽𝖾 𝖺𝗱𝗺𝗂𝗇. ✔️`, mentions: [who] }, { quoted: m })
    } catch (e) {
