...
export default {
  ...
  run: async (client, m, args, usedPrefix, command, text) => {
    try {
      if (!args[0]) return m.reply(`૮(ˊ ᵔ ˋ)ა ::  Ingresa 2 emojis para combinar.\n> Ejemplo: *${usedPrefix + command}* 👻+👀`)
      ...
      if (!res.results || res.results.length === 0) throw new Error('૮(ˊ ᵔ ˋ)ა ⚠️ ::  No se encontraron stickers para esos emojis.')
